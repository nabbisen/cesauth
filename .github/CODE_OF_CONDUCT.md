...
We — maintainers and contributors of cesauth — pledge to make
...
tracker, pull-request reviews, discussions, commit messages) and
when an individual is representing the project in public — for
example, posting via an official social-media account or acting as
an appointed representative at an event.

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behavior
may be reported by opening private security advisory: https://github.com/nabbisen/cesauth/security/advisories/new. All complaints
will be reviewed and investigated promptly and fairly. Maintainers
...
in determining the consequences for any action deemed in violation
...
in community spaces as well as external channels. Violating these
