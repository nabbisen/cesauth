...
use cesauth_frontend::admin::frame::{admin_frame_for, Tab};
use cesauth_frontend::tenancy_console::frame::{tenancy_console_frame_for, TenancyConsoleTab};
use cesauth_frontend::tenant_admin::frame::{tenant_admin_frame_for, TenantAdminTab};
use cesauth_frontend::templates::chrome::frame_for;
