...
pub fn for_tenant(
    ...
    let body = render_body(
        ...
        &format!("/admin/saas/tenants/{}/memberships/{}/delete", escape(tenant_id), escape(user_id)),
...
pub fn for_organization(
    ...
    let body = render_body(
        ...
        &format!("/admin/saas/organizations/{}/memberships/{}/delete", escape(org_id), escape(user_id)),
...
pub fn for_group(
    ...
    let body = render_body(
        &format!("/admin/saas/tenants/{}", escape(tenant_id)),
        &format!("/admin/saas/groups/{}/memberships/{}/delete", escape(group_id), escape(user_id)),
...
mod tests {
    ...
    fn tenant_remove_action_includes_user_id() {
        ...
        assert!(html.contains(r#"action="/admin/saas/tenants/t-acme/memberships/u-alice/delete""#));
