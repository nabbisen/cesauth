...
//! - `POST /admin/saas/tenants/:tid/memberships`
//! - `POST /admin/saas/organizations/:oid/memberships`
//! - `POST /admin/saas/groups/:gid/memberships`
//!
...
pub fn for_tenant(
    ...
    render(
        ...
        &format!("/admin/saas/tenants/{}/memberships", escape(tenant_id)),
...
pub fn for_organization(
    ...
    render(
        ...
        &format!("/admin/saas/organizations/{}/memberships", escape(org_id)),
...
pub fn for_group(
    ...
    render(
        principal, &title,
        &format!("/admin/saas/tenants/{}", escape(tenant_id)),
        &format!("/admin/saas/groups/{}/memberships", escape(group_id)),
...
mod tests {
    ...
    fn tenant_form_action_is_tenant_scoped() {
        ...
        assert!(html.contains(r#"action="/admin/saas/tenants/t-acme/memberships""#));
    }
