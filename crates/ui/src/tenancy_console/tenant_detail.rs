//! `/admin/tenancy/tenants/:tid` — one tenant's full picture.
...
mod tests {
    ...
    fn detail_page_lists_organizations() {
        ...
        assert!(html.contains("/admin/tenancy/organizations/o-eng"));
    ...
    fn member_link_points_to_user_role_assignments() {
        ...
        assert!(html.contains("/admin/tenancy/users/u-alice/role_assignments"));
    ...
    fn read_only_role_does_not_see_action_buttons() {
        ...
        assert!(!html.contains(r#"href="/admin/tenancy/tenants/t-acme/organizations/new""#),
            "ReadOnly must not see + New organization");
        assert!(!html.contains(r#"href="/admin/tenancy/tenants/t-acme/status""#),
            "ReadOnly must not see Change tenant status");
        assert!(!html.contains(r#"href="/admin/tenancy/tenants/t-acme/groups/new""#),
