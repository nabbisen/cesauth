//! `/admin/tenancy/users/:uid/role_assignments` — every role assignment
...
mod tests {
    ...
    fn operations_sees_grant_and_per_row_revoke() {
        ...
        let html = user_role_assignments_page(&p, &input);
        assert!(html.contains(r#"href="/admin/tenancy/users/u-alice/role_assignments/new""#));
        assert!(html.contains(r#"href="/admin/tenancy/role_assignments/a-1/delete?user_id=u-alice""#));
    }
}
