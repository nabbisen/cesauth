//! `GET /admin/saas` — landing page with deployment-wide counters.

use cesauth_core::admin::types::AdminAction;
use cesauth_ui::saas::overview::{OverviewCounts, PlanBreakdownRow};
use cesauth_ui::saas::saas_overview_page;
...
pub async fn page<D>(req: Request, ctx: RouteContext<D>) -> Result<Response> {
    ...
    render::html_response(saas_overview_page(&principal, &counts, &by_plan))
}
