//! `GET /admin/saas/organizations/:oid` — single organization view.
...
use cesauth_ui::saas::organization_detail_page;
use cesauth_ui::saas::organizations::OrganizationDetailInput;
